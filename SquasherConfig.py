defaultSettings = {
    ...
    'task_activity_log_file' : r"""C:\MyTemp\juherask\Dropbox\Notebook\Work\Tasks\TaskActivityLog.txt""",
    'keep_user_activity_log' : True,
    'user_activity_log_file' : r"""C:\MyTemp\juherask\Dropbox\Notebook\Work\Tasks\UserActivityLog.txt""",
